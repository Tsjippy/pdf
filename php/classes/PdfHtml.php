...
class PdfHtml extends \FPDF
{
    ...
    private function getRowHeight($colWidths, $row)
    {
        ...
        foreach ($row as $colNr => $cellText) {
            ...
            $cellText    = apply_filters('tsjippy-pdf-before-text', $cellText, $temp);
            ...
            do_action('tsjippy-pdf-after-text', $row[$colNr], $temp, $x, $y, $cellWidth, false);
    ...
    public function writeTableRow($colWidths, $row, $fill, $header)
    {
        ...
        foreach ($row as $colNr => $cellText) {
            ...
            $cellText    = apply_filters('tsjippy-pdf-before-text', $cellText, $this);
            ...
            do_action('tsjippy-pdf-after-text', $row[$colNr], $this, $x, $y, $cellWidth, true);
